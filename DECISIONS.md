...
| D6 | Rounding: primary increments 6 / 10 / 12 / 15 / 30 minutes (0.1 / 0.167 / 0.2 / 0.25 / 0.5 hour); default 15-min, round **up**; raw and rounded minutes both stored | Standard legal-billing increments; selectable per entry; admin/billing_clerk changes also update firm default. 'nearest'/'down' also supported; a positive entry never rounds to zero. |
