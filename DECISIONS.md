...
| D6 | Rounding default: 15-min increments, round **up**; raw and rounded minutes both stored | Firm requirement; visible in UI. 'nearest'/'down' also supported; a positive entry never rounds to zero. |
