#!/usr/bin/env node
/** Generate Waymark app icons (PNG) with no extra packages. */
...
function drawIcon(size) {
  ...
  fillCircle(rgba, size, size * 0.5, size * 0.5, size * 0.42, [45, 58, 120, 255]);
  fillCircle(rgba, size, size * 0.5, size * 0.5, size * 0.28, [232, 163, 23, 255]);
  fillCircle(rgba, size, size * 0.5, size * 0.5, size * 0.16, [28, 36, 64, 255]);
  fillCircle(rgba, size, size * 0.5, size * 0.5, size * 0.07, [244, 241, 234, 255]);
