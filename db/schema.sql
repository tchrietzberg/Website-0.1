...
-- Places: personal GPS pins + same-location chat rooms.
-- Coordinates are integer microdegrees (degrees * 1e6). Exact values stay on
-- the visitor's own rows; other users only see a ~100m-quantized centroid.
